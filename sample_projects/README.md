# Sample Verilog Projects

These folders are small test designs for `rtl_arch_visualizer`.

- `01_linear_chain`: three stages connected in a line with mismatched fan-in/fan-out.
